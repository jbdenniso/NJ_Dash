run_app:
	...
	find pages_files -exec sed -i.bak 's|_dash-component-suites|NJ_Dash\\/_dash-component-suites|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-layout|NJ_Dash/_dash-layout.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-dependencies|NJ_Dash/_dash-dependencies.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_reload-hash|NJ_Dash/_reload-hash|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-update-component|NJ_Dash/_dash-update-component|g' {} \;
	find pages_files -exec sed -i.bak 's|assets|NJ_Dash/assets|g' {} \;
